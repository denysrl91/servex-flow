...
export const MODULE_SCHEMAS: Record<string, ModuleSchema> = {
  ...
  "subcontractors": {
    defaultStatus: "pending",
    fields: [
      { key: "company_name", label: "Company Name", type: "text", required: true, primary: true, showInTable: true },
      { key: "principal_contact", label: "Principal Contact Name", type: "text", required: true, showInTable: true, secondary: true },
      { key: "trade", label: "Trade / Specialty", type: "select", options: ["HVAC","Electrical","Plumbing","Sheet Metal","Insulation","Controls","Refrigeration","Carpentry","General","Other"], showInTable: true },
      { key: "phones", label: "Phone Numbers (one per line)", type: "textarea", span: 2, placeholder: "Office: 555-123-4567\nMobile: 555-987-6543" },
      { key: "emails", label: "Emails (one per line)", type: "textarea", span: 2, placeholder: "primary@company.com\nbilling@company.com" },
      { key: "fax", label: "Fax", type: "tel" },
      { key: "website", label: "Website", type: "text" },
      { key: "address_street", label: "Street Address", type: "text", span: 2 },
      { key: "address_city", label: "City", type: "text" },
      { key: "address_region", label: "State / Region", type: "text" },
      { key: "address_postal", label: "Postal Code", type: "text" },
      { key: "address_country", label: "Country", type: "text", placeholder: "US" },
      ...
      { key: "insurance_expires", label: "Insurance Expires", type: "date", showInTable: true },
      { key: "workers_comp", label: "Workers Comp Policy #", type: "text" },
      { key: "payment_terms", label: "Payment Terms", type: "select", options: ["Net 15","Net 30","Net 45","Net 60","COD","Prepaid","Per Job"] },
      { key: "hourly_rate", label: "Hourly Rate", type: "currency" },
      { key: "commission_type", label: "Commission Type", type: "select", options: ["percentage","flat_fee"], showInTable: true },
      { key: "commission_percentage", label: "Commission %", type: "select", options: ["10","15","20","25"], placeholder: "If percentage" },
      { key: "commission_flat_fee", label: "Flat Fee Amount", type: "currency", placeholder: "If flat fee" },
      { key: "commission_notes", label: "Commission Notes", type: "textarea", span: 2, placeholder: "e.g. Company keeps 20% of every customer invoice; subcontractor receives 80%." },
      { key: "bank_name", label: "Bank Name", type: "text" },
      { key: "bank_account", label: "Bank Account #", type: "text" },
      { key: "bank_routing", label: "Bank Routing #", type: "text" },
      { key: "estimates_summary", label: "Estimates (refs / totals)", type: "textarea", span: 2, placeholder: "EST-2026-001 — $4,200 (Pending)" },
      { key: "invoices_summary", label: "Invoices (refs / totals)", type: "textarea", span: 2, placeholder: "INV-2026-014 — $3,800 (Open)" },
      { key: "paid_jobs_summary", label: "Paid Jobs (refs / totals)", type: "textarea", span: 2, placeholder: "Job #1042 — $2,500 paid 5/1/2026" },
      { key: "lifetime_paid", label: "Lifetime Paid", type: "currency", showInTable: true },
      { key: "rating", label: "Rating (1-5)", type: "number" },
      { key: "work_history", label: "Work History", type: "textarea", span: 2, placeholder: "Date — project — outcome / scope" },
      { key: "communication_log", label: "Communication Log", type: "textarea", span: 2, placeholder: "Date — channel — summary" },
      STATUS(["pending","approved","not_approved","on_hold","inactive"], "pending"),
      NOTES,
    ],
  },
